...
*/
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl){
        ...
        try {
            ...
            Log.e(LOG_TAG,"Problem makeing the HTTp request .",e);
        }
    ...
    public static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            JSONObject currentEarthquake  =new JSONObject(earthquakeJSON);
            JSONArray earthquakeArray=currentEarthquake .getJSONArray("features");

            for (int i=0; i<earthquakeArray.length();i++){

                JSONObject feature=earthquakeArray.getJSONObject(i);
                ...
                Earthquake earthquake = new Earthquake(magnitude, place, dateToDisplay, url);
